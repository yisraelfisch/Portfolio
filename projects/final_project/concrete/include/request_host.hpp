...
namespace ilrd
{
    ...
    public:
        ...
        //int SendMsgWrapper(std::shared_ptr<msg_struct_t> msg_struct);//move to transmitor
    ...
    private:
        RequestHost(){};
        NbdRequest *nbd_req;
        //std::set<int> fragment_set;// move to transmitor
        int num_of_fragments;
        int nbd_sock;
        uint32_t m_requestUid;
        std::unordered_map<int, std::shared_ptr<Transmitter>> trans_map;
