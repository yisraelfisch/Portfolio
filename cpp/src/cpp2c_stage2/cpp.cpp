...
public:
	...
	Centipede(const Centipede &other ) : Animal(other), m_numLegs(other.m_numLegs)
	{
...
public:
  ...
  : Animal(other), m_a1(new Centipede(static_cast<const Centipede&>(*other.m_a1))) ,m_a2(new Squirl(static_cast<const Squirl&>(*other.m_a2))), m_c(other.m_c), m_sq(other.m_sq)  
  {
